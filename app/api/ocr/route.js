...
- "type" = "expense" αν ο counterparty είναι ο χρήστης (αγορά), "income" αν ο issuer είναι ο χρήστης (πώληση)
- Συνήθως: issuer = προμηθευτής που πουλάει, counterparty = εμείς που αγοράζουμε
