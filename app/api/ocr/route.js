...
function getInvoicePrompt() {
  return `Διάβασε αυτό το τιμολόγιο ΠΟΛΥ ΠΡΟΣΕΚΤΙΚΑ.

ΣΗΜΑΝΤΙΚΟ: Το έγγραφο μπορεί να είναι:
- Κάθετο (portrait) — διάβασε κανονικά
- Οριζόντιο (landscape) — γύρισέ το νοητά 90 μοίρες και διάβασε
- Ανάποδο — γύρισέ το νοητά 180 μοίρες και διάβασε
Βρες τη σωστή κατεύθυνση και διάβασε ΟΛΑ τα στοιχεία.

Αν υπάρχουν πολλές εικόνες είναι σελίδες του ίδιου παραστατικού. Επέστρεψε ΜΟΝΟ JSON χωρίς backticks.
