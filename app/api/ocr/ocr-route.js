export async function POST(request) {
  try {
    ...
    const { base64, mediaType, mode, multiContent } = body
...
function getInvoicePrompt() {
  return `Διάβασε αυτό το παραστατικό ΠΟΛΥ ΠΡΟΣΕΚΤΙΚΑ. Επέστρεψε ΜΟΝΟ JSON χωρίς backticks.
...

{
  ...
  "items": [{"code":"","description":"","quantity":0,"unit":"","unit_price":0,"discount_pct":0,"net_value":0,"vat_rate":0,"vat_amount":0,"total":0}],
  "subtotal": 0,
  "total_discount": 0,
